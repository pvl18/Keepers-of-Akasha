...
def apply_professor_dashboard_css():
    """Apply professor-dashboard styles after the main app styles load."""
    st.markdown(
        """
<style>
...
# =========================================================
# INTEGRATED PROFESSOR DASHBOARD
# =========================================================

def render_professor_dashboard():
    """
    Render the real professor dashboard inside user_interface.py.
    The student/professor workspace selector remains owned by
    user_interface.py so there is one demo entry point.
    """

    # Apply professor styles at render time so they override student workspace CSS.
    apply_professor_dashboard_css()
...
# =========================================================
# STANDALONE PROFESSOR DASHBOARD
# =========================================================
